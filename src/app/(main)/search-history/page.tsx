...
import { deleteCV, searchCvHistory } from "@/lib/api";
          ...
          data?.map((item: any) => (
            ...
            >
              ...
              <div className="flex gap-4 align-middle items-center w-full">
                ...
                <button className="rounded-lg bg-[linear-gradient(100deg,_#0075FF_0%,_#0135FF_100%)] text-white h-12 w-[20%] text-sm">
                  See Results
                </button>
